...
function sendEmail() {
  ...
  Email.send({
    ...
    SecureToken: "",//you have to use a token
    Host: "smtp.elasticemail.com", //i used elasticmail for sending the mails
    Username: "",//here you have to attache the mail
    Password: "", //the password generated by them
